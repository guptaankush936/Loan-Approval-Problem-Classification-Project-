...
pickle_in = open(r"C:\Users\HP\classifier.pkl", 'rb')
...
def main():
    ...
    <h1 style ="color:black;text-align:center;"> Loan Allocation Prediction ML App</h1> 
    </div> 
    """
    ...
    Education = st.selectbox('Educational Status', ("Not Graduate", "Graduate"))
